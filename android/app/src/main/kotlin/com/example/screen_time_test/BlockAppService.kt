...
class BlockAppService : Service() {
    ...
    fun blockApps() {
        ...
        fun isAppInForeground(context: Context): Boolean {
            ...
            val beginTime = endTime - 1000 * 60 * 10 // 10 Minutes
            ...
            Handler(Looper.getMainLooper()).postDelayed(object : Runnable {
                override fun run() {
                    ...
                    if (isAppInForeground(this@BlockAppService) && !isDeviceLocked(this@BlockAppService)) {
                        if (shouldRunLogic) {
                            val intent = Intent(this@BlockAppService, FlutterBlockScreen::class.java)
                            intent.putExtra("route", "/blocked")
        ...
        for (app in apps) {
            // Exclude system apps and specify apps to block
            if ((app.activityInfo.packageName == "com.android.chrome" ||
                        app.activityInfo.packageName == "com.google.android.youtube") ||
